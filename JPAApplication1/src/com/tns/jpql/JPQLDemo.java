...
public class JPQLDemo {
	...
	public static void main(String[] args) {
		 ...
		 * EmployeeService.addEmployee(e1);
		 * 
		 * Manager m1=new Manager(); m1.setId(101); m1.setName("Neha");
		 * m1.setSalary(100000); m1.setDepartmentName("IT"); m1.setNoOfEmployees(15);
		 * ManagerService.addManager(m1);
		 * 
		 * m1=new Manager(); m1.setId(102); m1.setName("Nikhil"); m1.setSalary(80000);
		 * m1.setDepartmentName("Account"); m1.setNoOfEmployees(5);
		 * ManagerService.addManager(m1);
		 */

		List<Employee1> list = EmployeeService.getAllEmployeesByDept("Account");
